...
function App() {
  return (
    <Routes>
      ...
      <Route path="/categories/:slug" element={<PublicLayout><CategoryPosts /></PublicLayout>} />
      ...
      <Route path="/admin/categories/:id/edit" element={<AdminLayout><CategoryForm /></AdminLayout>} />
    </Routes>
  );
}
